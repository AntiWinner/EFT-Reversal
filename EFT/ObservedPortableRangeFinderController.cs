...
internal sealed class ObservedPortableRangeFinderController : PortableRangeFinderController, ObservedPlayer._E004
{
	internal new class _E000 : Player.UsableItemController._E001
	{
		public _E000(ObservedPortableRangeFinderController controller)
			: base(controller)
		{
		}
	...
	private new sealed class _E001 : PortableRangeFinderController._E002
	{
		private readonly ObservedPortableRangeFinderController _E08C;

		public _E001(PortableRangeFinderController controller)
			: base(controller)
		{
			_E08C = controller as ObservedPortableRangeFinderController;
		}
	...
	private new sealed class _E002 : PortableRangeFinderController._E003
	{
		public _E002(ObservedPortableRangeFinderController controller)
			: base(controller)
		{
		}
	}

	internal new class _E003 : _E004
	{
		public _E003(ObservedPortableRangeFinderController controller)
			: base(controller)
		{
		}
