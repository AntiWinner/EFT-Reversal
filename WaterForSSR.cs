...
public class WaterForSSR : MonoBehaviour
{
	...
	private sealed class _E001
	{
		...
		public WaterForSSR _003C_003E4__this;
	...
	[CompilerGenerated]
	private static Action<WaterForSSR> m__E000;

	[CompilerGenerated]
	private static Action<WaterForSSR> m__E001;
	...
	public static event Action<WaterForSSR> OnAdd
	{
		...
		add
		{
			Action<WaterForSSR> action = WaterForSSR.m__E000;
			Action<WaterForSSR> action2;
			do
			{
				action2 = action;
				Action<WaterForSSR> value2 = (Action<WaterForSSR>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange(ref WaterForSSR.m__E000, value2, action2);
			}
	...
	public static event Action<WaterForSSR> OnRemove
	{
		...
		add
		{
			Action<WaterForSSR> action = WaterForSSR.m__E001;
			Action<WaterForSSR> action2;
			do
			{
				action2 = action;
				Action<WaterForSSR> value2 = (Action<WaterForSSR>)Delegate.Combine(action2, value);
				action = Interlocked.CompareExchange(ref WaterForSSR.m__E001, value2, action2);
			}
			while ((object)action != action2);
		}
		[CompilerGenerated]
	...
	{
		OnValidate();
		if (WaterForSSR.m__E000 != null)
		{
			WaterForSSR.m__E000(this);
		}
	}
	...
	private void Update()
	{
		if (!(this.m__E003 == null))
		{
			...
			this.m__E003.SetFloat(_E019, Mathf.Lerp(AdditionalCubemapReflectionMinWetting, AdditionalCubemapReflectionMaxWetting, t));
		}
	}
	...
	private void _E000()
	{
		...
		_E008 = Shader.PropertyToID(_ED3E._E000(44835));
		_E009 = Shader.PropertyToID(_ED3E._E000(85683));
		_E00A = Shader.PropertyToID(_ED3E._E000(85667));
		_E00B = Shader.PropertyToID(_ED3E._E000(85716));
		_E00C = Shader.PropertyToID(_ED3E._E000(85711));
		_E00D = Shader.PropertyToID(_ED3E._E000(85755));
		_E00E = Shader.PropertyToID(_ED3E._E000(85742));
		_E00F = Shader.PropertyToID(_ED3E._E000(85790));
		_E010 = Shader.PropertyToID(_ED3E._E000(85769));
		_E011 = Shader.PropertyToID(_ED3E._E000(85763));
		_E012 = Shader.PropertyToID(_ED3E._E000(85814));
		_E013 = Shader.PropertyToID(_ED3E._E000(85799));
		_E014 = Shader.PropertyToID(_ED3E._E000(85845));
		_E015 = Shader.PropertyToID(_ED3E._E000(85832));
		_E016 = Shader.PropertyToID(_ED3E._E000(85827));
		_E017 = Shader.PropertyToID(_ED3E._E000(85878));
		_E018 = Shader.PropertyToID(_ED3E._E000(85865));
		_E019 = Shader.PropertyToID(_ED3E._E000(85916));
		_E01A = Shader.PropertyToID(_ED3E._E000(85889));
		_E01B = Shader.PropertyToID(_ED3E._E000(85942));
		_E01C = Shader.PropertyToID(_ED3E._E000(85926));
		_E01D = Shader.PropertyToID(_ED3E._E000(85979));
	}

	private void OnDisable()
	{
		if (WaterForSSR.m__E001 != null)
		{
			WaterForSSR.m__E001(this);
		}
	}
	...
	private void _E003()
	{
		...
		this.m__E003.SetTexture(_E008, Normals);
		this.m__E003.SetTexture(_E009, NormalsDetails);
		this.m__E003.SetTexture(_E00A, Foam);
		this.m__E003.SetVector(_E00B, new Vector4(DepthFade, DepthRefractions, DepthColorFade, BorderFade));
		this.m__E003.SetVector(_E00C, new Vector4(BorderFadeDistStart, 1f / BorderFadeDistRange));
		this.m__E003.SetFloat(_E00D, Bumpiness);
		this.m__E003.SetColor(_E00E, DepthColorDeep);
		this.m__E003.SetColor(_E00F, DepthColorShallow);
		this.m__E003.SetVector(_E010, new Vector4(FoamSize, 1f / FoamSize, FoamIntensity));
		this.m__E003.SetColor(_E011, FoamColor);
		this.m__E003.SetColor(_E012, ReflectionColor);
		this.m__E003.SetColor(_E013, DiffuseColor);
		this.m__E003.SetVector(_E014, NormalsA.GetVals());
		this.m__E003.SetVector(_E015, NormalsB.GetVals());
		this.m__E003.SetVector(_E016, NormalsDetails0.GetVals());
		this.m__E003.SetVector(_E017, FoamA.GetVals());
		this.m__E003.SetVector(_E018, FoamB.GetVals());
		_E004();
		this.m__E003.SetFloat(_E01A, RippleScale);
		this.m__E003.SetFloat(_E01B, RippleBumpness);
		this.m__E003.SetVector(_E01C, new Vector4(FresnelIntensity, FresnelPower));
		this.m__E003.SetTexture(_E01D, RippleTexture);
	}
	...
	private void _E004()
	{
		...
		{
			_E005 = this.m__E004;
			this.m__E003.SetFloat(_E019, Mathf.Lerp(AdditionalCubemapReflectionMinWetting, AdditionalCubemapReflectionMaxWetting, this.m__E004));
		}
	}
}
